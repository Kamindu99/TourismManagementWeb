...
import { VehiclSelectField } from "./Select.js";
...
const schema = {
    ...
    "properties": {
        "eventType": {
            "type": "string",
            "title": "Event Type",
            enum: ["SPORT EVENTS", "CULTURAL EVENTS", "ENTERTAINMENT EVENTS" , "EDUCATIONAL EVENTS"],
        },
        "eventName": {
            "type": "string",
            "title": "Event Name",
    ...
    const onSubmit = (e) => {
        ...
        axios.post("/sportevent/add", formData)
            .then((res) => {
                setAlertProps({
                    title: "Success",
                    description: "Event Add Successfull",
                    handleClose: { handleClose },
                    show: { show },
                    alertAction: () => {
                        return (
                            <>
                                <Button variant="primary" onClick={() => { window.location.href = "/admin-event"; }}>
                                    Continue
                                </Button>
                            </>)
                    }
